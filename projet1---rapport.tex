...
Comme nous allons appliquer Hastings-within-Gibbs, nous devrons
déterminer les lois conditionnelles de tous les paramètres de
l'expression de \(logit(p_i)\), c'est-à-dire que nous devrons obtenir
toutes les lois à posteriori. Pour \(\alpha_0\), nous aurons :
